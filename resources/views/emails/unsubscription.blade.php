...
<body>
    <div class="bg-success" style="padding: 7%;">
        <div style="margin: auto; background-color:white; max-width:580px; padding: 3%; border-radius:10px; box-shadow: 2px 2px 2px 1px rgba(0, 0, 0, 0.2);">
            ...
            <div style="margin: auto;">
                ...
                <p style="font-size:15px;">L'usuari <b>{{ $user->name . ' ' . $user->surname1}}</b> s'ha donat de baixa com a voluntari a l'oferta <b>{{ $offer->title }}</b>.</p>
                <br>
                <div style="text-align: center; margin: 5% auto;">
                    <a class="bg-success" href="{{ route('offer.show', ['id'=>$offer->id]) }}" style="text-decoration: none; margin: 5% auto; padding: 2% 5%; border-radius:10px; border:0px; color:white; font-size: 18px;">Veure oferta</a>
                </div>
                <br>
                <h3><b>Gràcies!</b></h3>
            </div>
